...
class SingleTest(unittest.TestCase):
    ...
    def test_no_snatch(self):
        ...
        "Single")
        backends.check_radarr_rx(self, "this is a name",
        "animal: cow &mood=angry f1: first_fixed f2: fixed_second",
        "Single")
        backends.check_lidarr_rx(self, "this is a name",
        "animal: cow &mood=angry f1: first_fixed f2: fixed_second")
    ...
    def test_sonarr_snatch(self):
        ...
        backends.check_sonarr_rx(self, "son snatch",
        ...
        db.check_announced(self, "son snatch",
                "animal: dog &mood=sad f1: first_fixed f2: fixed_second",
                "Single",
                ["Sonarr", "Radarr", "Lidarr"],
                ["Sonarr"])
    ...
    def test_radarr_snatch(self):
        ...
        backends.check_radarr_rx(self, "rad snatch",
        ...
        db.check_announced(self, "rad snatch",
                "animal: cat &mood=happy f1: first_fixed f2: fixed_second",
                "Single",
                ["Sonarr", "Radarr", "Lidarr"],
                ["Radarr"])
    ...
    def test_lidarr_snatch(self):
        ...
        backends.check_lidarr_rx(self, "lid snatch",
        ...
        db.check_announced(self, "lid snatch",
                "animal: rat &mood=curios f1: first_fixed f2: fixed_second",
                "Single",
                ["Sonarr", "Radarr", "Lidarr"],
                ["Lidarr"])
    ...
    def test_renotify_radarr(self):
        ...
        backends.check_sonarr_rx(self, "son snatch2",
        ...
        db.check_announced(self, "son snatch2",
                "animal: horsie &mood=calm f1: first_fixed f2: fixed_second",
                "Single",
                ["Sonarr", "Radarr", "Lidarr"],
                ["Sonarr"])
        ...
        backends.check_radarr_rx(self, "son snatch2",
        "animal: horsie &mood=calm f1: first_fixed f2: fixed_second",
        "Single")
